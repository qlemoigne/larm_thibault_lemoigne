...
#            ),
    ...
    return LaunchDescription([
        ...
        Node(package='rviz2',namespace='', executable='rviz2', arguments=['-d /home/bot/ros2_ws/src/tuto_sim/launch/launch_config.rviz']),
        Node(package='teleop_twist_board', executable='teleop_twist_board')
